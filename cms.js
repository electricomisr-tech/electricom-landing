...
(function () {
  ...
  const DEFAULT_CONTENT = {
    ...
    hero: {
      ...
      stat1_number: 'חשמל', stat1_label: 'תכנון והתקנה',
      stat2_number: 'תקשורת', stat2_label: 'רשתות מקצועיות',
      stat3_number: 'אבטחה', stat3_label: 'מצלמות ובקרה',
    },
    about: {
      badge_title: 'מומחיות הנדסית בכל פרויקט',
      badge_desc: 'מובילים בתחום עם ניסיון בלתי מתפשר באלפי פרויקטים מוצלחים',
      tag: 'אודות אלקטריקום',
      title: 'מקצוענות ואמינות בכל פרויקט',
      paragraph1: 'אלקטריקום מערכות הוקמה מתוך אמונה שכל לקוח ראוי לפתרון איכותי, מקצועי ומותאם אישית. אנחנו מתמחים בתכנון, הקמה ותחזוקה של תשתיות חשמל, תקשורת ואבטחה - ומספקים שירות אישי וחם לצד מומחיות טכנית ברמה הגבוהה ביותר.',
    ...
    footer: {
      description: 'מומחים בתשתיות חשמל, תקשורת ואבטחה. שירות מקצועי, אחריות מלאה ופתרון מקצה לקצה - לתעשייה ולמוסדות.',
    },
    partners: {
      title: 'המותגים המובילים שאנחנו עובדים איתם',
      items: [
        // חשמל ותאורה
        { name: 'Schneider Electric', logo: 'logos/schneider-electric.png' },
        ...
        { name: 'NISKO',              logo: 'logos/nisko.png' },
        ...
        { name: 'D-Link',             logo: 'logos/d-link.png' },
        { name: 'Panduit',            logo: 'logos/panduit.png' },
        // אבטחת רשת / Firewall
        { name: 'Check Point',        logo: 'logos/check-point.png' },
        { name: 'Fortinet',           logo: 'logos/fortinet.png' },
        { name: 'Palo Alto',          logo: 'logos/palo-alto.png' },
        // מצלמות ואבטחה פיזית
        ...
        { name: 'Visonic',            logo: 'logos/visonic.png' },
      ],
    },
  };
